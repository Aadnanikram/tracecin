...
class TabsState extends State<Tabs> with SingleTickerProviderStateMixin {
  ...
  Future<void> share(dynamic link, String title) async {
    await FlutterShare.share(
        title: 'Cryptofolio',
        text: 'Share',
        linkUrl: 'https://play.google.com/store/apps/details?id=com.cryptofolio.cryptocurrencytracker.app',
                                ...
                                Container(
                                  ...
                                  Column(children: <Widget>[
                                    Container(
                                      ...
                                      width: 60,
                                      height: 60,
                                      child: Image.asset('assets/icontwo.png'),
                                    ),
                                    Text("Cryptofolio", textDirection: TextDirection.ltr, style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 16.0),),
                                    Text("Version 1.0", textDirection: TextDirection.ltr, style: TextStyle(color: Colors.white, fontSize: 12.0),)
                                  ],)
                                  ,)
                              ],)
                          ),
                        ...
                        new ListView(
                          children: <Widget>[
                            new ListTile(
                              ...
                              onTap: () => _launchURL("https://play.google.com/store/apps/details?id=com.cryptofolio.cryptocurrencytracker.app"),
                            ),
                            ...
                            new ListTile(
                              ...
                              title: new Text("WB Design"),
                              onTap: () => _launchURL("https://play.google.com/store/apps/developer?id=WB+Design"),
                            ),
                            new Container(
                              decoration: new BoxDecoration(
                                  border: new Border(
                            ...
                            RaisedButton(
                                ...
                                onPressed: () {
                                  Share.share('check out my App https://play.google.com/store/apps/details?id=com.cryptofolio.cryptocurrencytracker.app', subject: 'Look what I made!');
                                }
                            ),
                          ],
                        ),
